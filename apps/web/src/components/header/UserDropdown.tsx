...
export default function UserDropdown({ nombre, email, signOut }: UserDropdownProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 overflow-hidden rounded-full h-11 w-11 bg-brand-500 text-white font-semibold">
          {inicial}
        </span>
