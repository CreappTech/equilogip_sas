...
export type FiltrosProgramacionSemanal = {
...
export async function listarProgramacionSemanal(
  ...
  let query = supabase
    ...
    .gte("fecha", filtros.semana_inicio)
    .lte("fecha", fechaFin)
    .order("fecha")
